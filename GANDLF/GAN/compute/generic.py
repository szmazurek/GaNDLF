...
def create_pytorch_objects_gan(
    ...
    Args:
        ...
        train_csv (optional, str): The path to the training CSV file.
        val_csv (optional, str): The path to the validation CSV file.
        device (str): The device to perform computations on. Defaults to "cpu".
